...
<body>
        ...
        <tbody>
            @foreach($bandeiras as $bandeira)
                <tr>
                    ...
                    <td>
                        <form action="http://localhost:8000/api/bandeiras/{{ $bandeira->id }}" method="POST" onsubmit="return confirm('Tem certeza que deseja excluir esta bandeira?');">
                            @csrf
                            @method('DELETE')
                            <button type="submit">Excluir</button>
                        </form>
                        <a href="http://localhost:8000/api/bandeiras/{{ $bandeira->id }}/edit"><button>Editar</button></a>
                    </td>
                </tr>
            @endforeach
        </tbody>
   ...
   <a href="http://localhost:8000/api/bandeiras/create"><button>Criar nova bandeira</button></a>
</div>
</body>
</body>
</html>
