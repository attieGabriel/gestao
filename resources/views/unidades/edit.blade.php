...
<body>
    ...
    <form action="{{ route('unidades.update', $unidade->id) }}" method="POST">
        ...
        <input type="text" id="nome_fantasia" name="nome_fantasia" value="{{ $unidade->nome_fantasia }}" required>
        <br>

        <label for="razao_social">Razao Social:</label>
        <input type="text" id="razao_social" name="razao_social" value="{{ $unidade->razao_social }}" required>
        <br>

        <label for="cnpj">CNPJ:</label>
        <input type="text" id="cnpj" name="cnpj" value="{{ $unidade->cnpj }}" required>
        <br>
